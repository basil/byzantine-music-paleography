---
title: "Chapter 2 – Elements of Greek Palaeography and Byzantine Codicology"
weight: 20
---
## Summary

This chapter offers the reader a brief introduction to the world of Greek Palaeography and Codicology. First, it presents elements concerning writing materials (papyrus, parchment, paper), the forms of manuscripts and other features (scroll, codex, binding, ruling, palimpsests), the liturgical contexts of Byzantine musical codices, and elements for their analytical description. It then discusses the various types of Greek alphabetic script (majuscule and minuscule, with their subcategories), punctuation marks, as well as prosodic signs. The chapter concludes with aids for the reading and editing of Greek manuscript texts, and with sample exercises from manuscripts of the pre-Byzantine, Byzantine, and post-Byzantine periods.

## Prerequisite Knowledge

This chapter presupposes the study of Chapter 1. For further study in the field of the Palaeography of the Greek Language, reading the following books is recommended: Mioni (1998) and Litsas (2001).

## 1. Prolegomena

### 1.1. The Palaeography of the Greek Language and Its Branches: Definitions

The Palaeography of the Greek language is the science concerned with the evolution and the
formation of the Greek scripts, chiefly from Linear B (ca. 1550 BC) until the beginning of the 20th
century, when typography definitively prevailed in almost all fields of knowledge.i
...
the first handbook in this field, entitled Palaeografia graeca (Paris,1708)v (see Figure 2.1). In
this particular book, Montfaucon refers, among other things, also to Greek musical notation, which he
...
Initially a chapter of Palaeography proper, Codicology is today a dynamically developing branch
of Palaeography. Codicology deals with the history and morphology of
codices (the Greek word κῶδιξ derives from the Latin caudex/codex, plur. codices = tree trunk,
piece of wood, book, writing).viii Specific issues of codicology include the external and
internal form of the codex (binding, writing material, type of script and scribe of the manuscript, etc.),
its dating, the patron who commissioned and financed the manuscript and its owners,
...
later, paper.
If we refer specifically to the written witnesses of Greek musical culture, these
are recorded on stone, clay, papyrus, parchment, paper and—from the end of the 20th century—on
digital media.
In the present book we shall deal somewhat more analytically with the materials that were used for
the notation of Greek music during the pre-Byzantine, Byzantine, and post-Byzantine periods, which
...
it gradually began to be displaced by parchment. Its use during the Middle Ages is sporadic.xii
The word papyrus (in Latin cyperus papyrus) goes back to the Egyptian word pa-per-aa (= the things of
Pharaoh, royalxiii) and names a marsh plant which in Antiquity grew in Egypt
...
From the white stalk of the plant, cut lengthwise into thin strips, were made
...
(see Map 2.1).
All kinds of texts were recorded on papyri, from notes for everyday use, which constitute the
overwhelming majority of the surviving papyri, to major literary works and scientific texts
(mathematical, medical, music-theoretical, etc.). Most papyri are written in Greek and Latin
(ca. 80% of published papyri); the oldest are in Egyptian hieroglyphs, while still others are in Coptic,
Aramaic, or Persian.xvii
In the Mouseion of Alexandria, from the beginning of the 3rd c. BC, there operated the largest
library of the ancient world. It is thought to have held around 700,000 scrolls when it caught fire,
...
Antiquity. © Google earth.
Sources: Google earth & places marked

by Demosthenes Spanoudakis.

The rediscovery of papyri, which are very fragile and are preserved only in dry and enclosed places
that do not come into contact with moisture and air, began in the 18th century, with the excavations at
...
We shall deal in greater detail with the famous musical Oxyrhynchus Papyrus 1789 in ch. 5.
Other important discoveries of papyri were made during the 20th century in the city of Dura-Europos
in Mesopotamia, on the banks of the Euphrates, and in the caves of Qumran (near the Dead Sea:
scrolls with biblical and liturgical texts, etc.).xxi
The oldest papyrus of Europe known today was found in 1962 at Derveni near
...
“the oldest book in Europe.” It contains an interpretation of an Orphic hymn. It is exhibited in the Archaeological Museum
of Thessaloniki. In the image: a photographic reproduction of a fragment of the scroll.
Image source: <https://upload.wikimedia.org/wikipedia/commons/b/bb/Derveni-papyrus.jpg> (8.8.2016).xxiii

The largest collection of papyri is today in Oxford, with ca. 400,000 fragments:
<http://www.papyrology.ox.ac.uk/POxy/> (8.8.2016).
Other important collections of papyri are housed in museums: in Vienna,
Berlin: <http://ww2.smb.museum/berlpap/> (8.8.2016), Florence, and in the Universities:
of Heidelberg: <http://www.rzuser.uni-heidelberg.de/~gv0/Papyri/P.Heid._Uebersicht.html> (8.8.2016),
of Cologne: <http://www.uni-koeln.de/phil-fak/ifa/NRWakademie/papyrologie/> (8.8.2016),
of Trier: <http://digipap.uni-trier.de/papy.php> (8.8.2016),xxiv
...
a writing material made from the hide (flayed skin) of various animals, usually lamb or sheep, goat,
calf, more rarely ass (donkey) or even pig. The refined manufacturing method of
...
Sources: <https://commons.wikimedia.org/wiki/File:Parchment_from_goatskin.jpg> (15.2.2016).
...
Map 2.2. The Kingdom of Pergamon on a map of Asia Minor after the year 188 BC.
Source: <http://en.wikipedia.org/wiki/File:Asia_Minor_188_BCE.jpg> (13.3.2012).

According to Pliny the Elder (AD 23-79, author of Natural History - Naturalis
Historia, book XIII, ch. 21),xxix the Latin scholar Marcus Terentius Varro (116-27 BC) circulated a
story according to which the Egyptian king Ptolemy V Epiphanes (205-180 BC) and Eumenes II,
king of Pergamon (197-158 BC) of the Attalid dynasty, were competing as to who would
have the better library (in Alexandria or, respectively, in Pergamon). In order to halt
Eumenes’ work, the Egyptian king stopped the export of papyri to Pergamon, and thus
in the Asia Minor city, which at that time was at its zenith, the manufacture of
parchment began.xxx Although the reliability of this story was shaken by the fact that texts were found
...
Byzantium.
Between the writing material (lamb’s hide) and the content of the New Testament there was created
in the Byzantine period a close symbolic association: see, indicatively, in the Revelation of John,
ch. 21, v. 27: “those written in the Lamb’s book of life.”xxxii
Luxury codices were made from high-quality parchment (e.g. the so-called
charta virginea, made from the skin of an unborn calf). Especially renowned are the so-called codices
purpurei—purple codices—of the golden age of St Justinian (6th c.) in the East, or of the age of the
Carolingians (8th-9th c.) in the West,xxxiii which consist of parchment leaves dyed purple,
...
of the codex: Syria. The text is written in various directions: above, in the first two lines, it is from
...
Subsequently, paper mills were founded in Samarkand, Aleppo, Damascus, and other cities
of the Middle East. This so-called Arab or Eastern paper also spread to Byzantium, especially from
the 12th century onward, and was used both in administration and for the production of codices,
gradually outstripping parchment. From the city of Bambyce in Syria, a commercial centre
of paper, there seems to derive the name bambykinon or bombykinon, which is used from time to time
for manuscripts made of paper.
With the Arabs, paper also came to the West: first to Spain, during the 12th century (paper mills
...
freely distributed chain lines.
By contrast, Western paper has a rough surface, a white or yellowish colour, somewhat more widely spaced laid
lines, while the chain lines are distributed at regular intervals.xxxviii In addition, Western paper
usually contains the so-called watermarks, special designs (e.g. crowns, flowers, animals, etc.), which
constituted the identifying sign—the brand—of the particular paper mill.xxxix
...
The type of paper, and especially the watermarks, are an important aid in dating
those manuscripts that do not bear a bibliographical note indicating their date.
...
was made over fire. The correct proportion of vegetable, later also tannic, substances and metallic
salts ensured the good quality of the ink, which, with the passage of time, would not fade
or, conversely, perforate the parchment or paper.xlii The use of red ink (sacrum encaustum)
...
In other categories of documents, however, no such restriction applied. In musical manuscripts, for example,
black ink is used for the poetic text and for the majority of the musical signs.
...
kyr John Koukouzeles, from the beginning of Great Vespers up to and including the completion of the
Divine Liturgy.” © National Library of Greece.xlvi

For the writing of manuscripts, scribes used the reed pen (kalamos or graphis). From the
4th c. AD onward, they also used the kondylion, that is, a pen made from a bird’s feather (usually
goose). Both the reed pen and the kondylion were sharpened with a small knife. In the middle of the nib there was a small slit,
as in modern pens.
...
reed pen (behind the Evangelist’s right ear), two open parchment codices, one in the Evangelist’s lap
and the other on a lectern, and a small knife with which the scribe is scraping away a letter in the text, which is written in
majuscule script and constitutes the beginning of the Gospel according to Luke: SINCE MANY HAVE
UNDERTAKEN TO SET IN ORDER A NARRATIVE. On the parchment are also visible the horizontal and vertical
lines (the so-called ruling), which ensure the straight recording of the text. On the small table
in front of the Evangelist rest a wooden casket, a pair of scissors, two other pointed instruments, and a small
...
could have a covering/decoration, e.g. of ivory (see Figure 2.14).
Other names for the scroll were byblos, biblion, eiletarion (Lat. liber, libellus, volumen). The
...
are fastened within a cover.xlix The name and form of the codex arose from
joined wooden waxed tablets (known by the names: pinax, pinakis, deltion,
deltidion, pyction, grammateion), which were in use in antiquity chiefly for everyday
writing, for teaching, etc.l Between wooden tablets papyrus
leaves could also be fastened, and later parchment leaves. The codex spread from the 4th c. AD,
chiefly in its parchment form, and prevailed in this form from the 5th-6th century onward. Of decisive importance for
the transition from the scroll and papyrus to the codex and parchment was the spread of
Christianity through Holy Scripture—the Bible (see Figure 2.15).li
From the 13th century onward, codices also appear in paper form.
Nevertheless, alongside the codex, the Byzantine tradition also retained the form of the scroll for
...
of the 6th c. The Lord blesses with His right hand, while in His left He holds the Gospel in the form of a codex with a luxurious
cover and clasps.
Sources: <https://upload.wikimedia.org/wikipedia/commons/9/9a/2049_-_Byzantine_Museum%2C_Athens_->
...
Source: <https://upload.wikimedia.org/wikipedia/commons/f/fd/Byzantine_Constantinople-el.svg> (30.8.2016).

Saint Theodore the Studite (759-826), abbot of the Holy Monastery of Stoudios and “reformer of
monastic life in the 9th century,”liv gives an image of the good order that was to prevail in a
scribal workshop, writing with regard to the monks in the calligrapheion, among other things, the following
regulations:
“Concerning the calligrapher (...)
54. If he does not hold the quire carefully, and place the book from which he is writing,
and cover both at the proper time, and if he does not observe the correspondences, the accents, and the
punctuation marks: 30 and 100 prostrations. (...)
...
√ The folding of the parchment into two or more parts (into four or into eight [Lat. in-quarto, in-octavo]

according to the size of the skin): see Diagrams 2.1-7).

√ The formation of the basic units of the book, the so-called quires, and the cutting of the leaves.

There are quires that consist of two bifolia (dyads or doublets, Lat. biniones), of three bifolia
(triads, terniones), of four bifolia (tetrads or quaternions, quaterniones), or even of more
...
To this day the sixteen-page quire constitutes the basic typographical unit. Each quire
received numbering by numeral letters on its first and last leaf (the so-called guards),
...
can help in the dating and determination of the provenance of manuscripts. A general
systematisation of various types of ruling, and thus an important instrumentum studiorum for the study of
...
Historical Museum, Moscow, Șciukin Collection, MS 350.lxiii © State Historical Museum, Moscow.
...
miniatures found in illustrated manuscripts is an object of the History of Byzantine
Art. Since chanters, hymnographers, melodists, or musical instruments are depicted, these miniatures also become
objects of Musical Iconography.lxv
The study of the palaeography of Byzantine music can also bring us into contact with
...
codex of 400 leaves required skins from an entire flock! For reasons of economy, therefore, parchments
and more rarely papyri,lxviii could be recycled. Such recycled leaves are called
palimpsests (from the adverb palin + the verb psao [= I scrape off, erase], that is, leaves/manuscripts/codices scraped
again/for a second—and rarely for a third—time).lxix
The erasure of the earlier writing (underlying writing—scriptio inferior) included the
soaking of the parchment leaves in milk, their washing with a sponge, and their rubbing with
pumice.lxx After the leaves had dried, a new ruling could be carried out and the new text written
over it. From the process of rewriting, these codices are called in Latin
codices rescripti. Very often the new writing (overlying writing—scriptio superior) is
placed, for practical reasons, between the old lines, or in the opposite direction, since it
was not possible in all places to make the letters of the underlying writing disappear completely.lxxi
For the decipherment of the underlying writing, various aids have been used from time to time:
chemical reagents (e.g. tannic substances or ammonium sulphide), which, however, had
a destructive effect on the particular leaves, since after a short period of time they became
black,lxxii reading with an ultraviolet lamp, photography with infrared rays, etc.lxxiii
From the late 20th and early 21st century, new methods of studying
palimpsests were developed with the aid of computers, which led to spectacular results.lxxiv
The new methods for the study of palimpsests as well as of other difficult-to-read manuscripts
include advanced multispectral imaging techniques, Statistical Processing Techniques
applied to spectral images, etc. The various techniques are based on exploiting the difference between
the colour of the parchment, the first writing, and the second writing. Especially helpful in the
attempt to decipher the first layer of writing of a palimpsest are the processed,
pseudocolor images, which increase the difference between the two writings
...
Underlying writing, late 5th c.: Fragment of the Gospel according to Luke, ch. 9, 22-33, in the Greek language, in
majuscule biblical Egypto-Nitrian script.
Overlying writing, 8th or 9th c.: Syriac text of Severus of Antioch, Contra impium grammaticum (referring to the
Orthodox John the Grammarian). To facilitate the study of the palimpsest, the overlying writing was coloured with
whiter colours, using modern digital technology.lxxvi
Sources: <https://commons.wikimedia.org/wiki/File:Codex_Nitriensis,_f.20r_(Luke_9,22-33).jpg> (8.8.2016).
Dating of the underlying writing and description of the script: Litsas (2001, pp. 22-23).
See also <https://en.wikipedia.org/wiki/List_of_New_Testament_uncials> (8.8.2016).
<https://en.wikipedia.org/wiki/Codex_Nitriensis> (8.8.2016).

The best-known palimpsest manuscript today is the Archimedes Codex (Walters Art Museum,
U.S.A.).lxxvii
In the present handbook, a reference has already been made to the palimpsest Princeton Garrett 64 (see above,
...
more recent times (19th-20th c.). Bearing in mind that liturgical life occupies a central position in the
Byzantine tradition, recent research aims at a holistic consideration-analysis of Byzantine
ecclesiastical-liturgical manuscripts within their generative worship context, on the basis of
codico-liturgical methodology.lxxix
The nucleus of the large family of Byzantine liturgical books consists of three
manuscripts with texts of Holy Scripture: the Gospel, which is the “heart” of the whole edifice
(containing readings from the four Gospels of the New Testament), the Apostolos (with readings
from the Acts of the Apostles and the Epistles of the New Testament), and the Psalter (it contains the
150 Psalms of the Old Testament) (see Diagram 2.1).
...
liturgical collections developed, interacting with one another on the basis of the Typikon. The Typikon may be
regarded as a ‘meta-liturgical book’, containing the rubrics for the performance of the various
offices of the movable festal cycle (centred on Easter) and of the fixed festal cycle
...
cataloguers have followed from time to time: general description, analytical description, and a mixed mode
of description. An indispensable guide to the process of analytical cataloguing of manuscripts of
Byzantine music was offered by Gregorios Stathis through his colossal cataloguing
work.lxxxiii Important models of analytical cataloguing of individual manuscripts are also found
in the accompanying Supplementa fascicles of the main Facsimilés series of the Monumenta Musicae
Byzantinae in Copenhagen.
An open list of elements that may be included in an analytical catalogue
of Byzantine musical manuscripts comprises the following:lxxxiv

1. Information concerning the type of manuscript according to its contents, its provenance, date, material, dimensions, number of folios, number of columns and lines per folio, palimpsest folios,

2. analytical description of the contents of the codex, with the incipits of all pieces and with bibliographical references for individual pieces (where these exist),
...
• Stathis, Gr. (1975, 1976, 1993, 2015). The Manuscripts of Byzantine Music, Mount Athos, Descriptive Catalogue.

Holy Synod of the Church of Greece, IBM, vols. I–IV. Athens. • Stathis, Gr. (2006). The
Manuscripts of Byzantine Music, Meteora, Descriptive Catalogue. Holy Synod of the Church of
Greece, IBM. Athens. • Stathis, Gr. (2016). The Originals of the Exegesis into the New Method
of Notation. Vol. I. The Prolegomena & Vol. II. The Catalogue. Holy Synod of the Church of
Greece, IBM. Athens. • Chatzigiakoumis, M. (1980). Manuscripts of Ecclesiastical Music 1453–1820.
Contribution to the Study of Modern Hellenism. Athens: National Bank of Greece. • Giannopoulos, Emm. (2008).
The Manuscripts of Byzantine Music. England. Descriptive Catalogue. Holy Synod of the Church of
Greece, IBM. Athens. • Chaldaiakis, A. (2005). The Manuscripts of Ecclesiastical Music, Island Greece,
...
types of alphabetic script that were in use from classical Antiquity to the post-Byzantine
...
|---|---|---|---|---|
|Cursive|• Letters ἐπισεσυρμένα = letters written quickly, (roughly).lxxxvii • It presents several types: 1. MAJUSCULE CURSIVE: attested from the 4th c. BC to the 3rd/4th c. AD and later, 2. minuscule cursive. Various subcategories are distinguished: a. Greco-Roman cursive: 4th–5th c. AD, b. Byzantine cursive: from the Justinianic period onward (6th c.). In turn, Byzantine cursive appears in various forms: i. the common hand: the usual script of very|everyday life, letters, deeds of purchase and sale|spontaneous, personal|Public and private documents (wills, legal acts, notarial documents) are the object of the discipline called Diplomatics.|
||ii. the bureaucratic script (see Figure 2.20). The boundaries between the common hand and bureaucratic script are sometimes blurred.lxxxviii|artificial script with many superfluous strokes, elaborate, for ensuring the authenticity of|official, standardized||
...
only from the 8th and especially the 9th century onward, after Iconoclasm (726–843), in the general climate of renewal of the
Macedonian Renaissance (late 9th–first half of the 11th c.) and during the transition from majuscule to
minuscule script.
Majuscule script appears in manuscripts until the 8th/9th century, usually as
continuous writing (scriptio continua), that is, as a continuous flow of letters, without spaces between
words, without accents (acute, grave, circumflex) and breathings (smooth, rough), and without punctuation marks.
In some old manuscripts in majuscule script, these aids for reading the
text (punctuation marks, prosodic signs) were added later. Table 2.2 shows the
punctuation marks attributed to Aristophanes of Byzantium:

|Punctuation mark|Example|Function and equivalent|
|---|---|---|
|upper point|A ̇|longer pause|
|lower point (placed on the baseline of the text)|A.|short pause, like the modern comma|
|middle point (placed in the middle of the height of the letters)|A·|corresponds to the modern Greek ano teleia|

Table 2.2. Punctuation marks of Aristophanes of Byzantium.xci Apart from the points (chiefly the upper point), in
Byzantine musical manuscripts the comma (,) also appears, more rarely. The point (full stop) was also adopted into the system
of palaeo-Byzantine notation, where it functions as a musical sign at the end of phrases.

The next Table 2.3 concerns prosodic signs. These formed part of the
lesson in Greek grammar.xcii Prosodic signs are of great importance, both for
ancient Greek and for Byzantine music, since some of them were incorporated also into
...
below, ch. 5, section 9, with Figure 5.22.

More recent research on Byzantine liturgical texts has brought to light other systems of punctuation, which document the existence of a many-sided
...
limit.”xcvii
A great variety of forms of Greek majuscule script appears in written sources
dated from the beginnings of Greek alphabetic writing, the 8th c. BC, down to
the present. Tracing the developmental course of Greek majuscule script begins with the study
of inscriptions, where the letters are carved with a chisel in stone, first from right to left,
later boustrophedon (left to right the first line, right to left the second, again
left to right the third, etc.), and from the 5th c. BC from left to right.
From the 4th c. BC onward the use of the majuscule script of inscriptions (the
so-called epigraphic script) is also documented for the recording of literary texts on papyrus.
Until the 3rd c. AD the characters of Greek script were all majuscule. From the 4th
century onward various types of Greek minuscule script developed, first the so-called
...
|Bacchylidean capital|Named after the papyrus roll of Bacchylides,xcix Papyrus Londinensis 733, early 2nd c. AD (Mioni, 1998, p. 65 and pl.|
|Roman capital|Pap. Hawâra 24-28, Oxford, Bodleian Library, second half of 2nd c. AD (Litsas, 2001, pp. 12–13).|
|Biblical majuscule|• Appears at the end of the 2nd c. AD and is standardized around the middle of the 4th c. • Its establishment is linked with important historical factors: - the replacement of the roll and papyrus by the codex and parchment, - the spread of Christianity. • The most representative samples of this script are found in mss. containing the Bible, e.g. - Codex Vaticanus graecus 1209, early–mid 4th c., “the oldest codex of the New Testament”, also known as Codex B: <http://digi.vatlib.it/view/MSS_Vat.gr.1209> (25.11.2015). See also Follieri (1969, pl. 1). Litsas (2001, pp. 14- 15).|
||- Sinaitic codex Londinensis gr. Addit. 43725, beginning of the second half of the 4th c.: <http://www.codex-> sinaiticus.de/en/manuscript.aspx?book=38&chapter=13&lid=en&side=r&zoomSlider=5# (8.9.2016). See also Litsas (2001, pp. 16–17). • From the end of the 5th c. certain local peculiarities of biblical majuscule script are distinguished: - in codices from Constantinople: see the luxurious medical codex of Dioscorides in Vienna (Vindobonensis med.gr. 1), 6th c.: Mioni (1998, pp. 70–71 and pl. V). Litsas (2001, pp. 26–27). See also the Alexandrian codex of Holy Scripture Londinensis gr. Royal 1 D. v-viii, from the third quarter of the 5th c., with Constantinoplec as probable place of origin (see Figure 2.22),|
...
||• It survives mainly in codices of the 6th–10th c.: see, e.g., Mioni (1998, p. 73 and pl. VI). Litsas (2001, pp. 32–33). • It is used by the Copts as their national script. codex Marchalianus (Vaticanus gr. 2125), end of the 7th c./8th c.:|
|Ogival majuscule|• Appears in two types: a. sloping or inclined (Ital. maiuscula ogivale inclinata, Germ. Spitzbogenmajuskel): Samples survive from the 5th–9th c.: see, e.g., the Uspenskij Psalter (Petropolitanus gr. 216) of the year 862 (Litsas, 2001, pp. 38–39 and other examples pp. 33–36, 40–41). See also the Tropologion Sinaitici graeci majuscule ΜΓ 56+5, 9th c. (Nikiforova, 2015, p. 141 et passim), with photographs in Archbp. Damianos, Archim. Sophronios, Peltikoglou and Nikolopoulos (1998, photos 11, 49) and Figure 2.24 below, as well as the Tropologion Codex Sinaiticus Liturgicus, today in St Petersburg, Russian National Library 44, from the of the 9th c.” and Chronz, under|
||Figure 2.24. Excerpt in copy from the Sinai Tropologion ΜΓ 5, in majuscule ogival sloping script, 9th c. (Nikiforova).ciii|
...
|---|---|
||Figure 2.26. Excerpt from the Iași Gospel, f. 5r, in majuscule liturgical script, with ekphonetic notation. Source: Panțiru, Grigore. (1971). Notația și ehurile muzicii bizantine. București: Editura Muzicală a Uniunii Compozitorilor, p. 161. With the kind permission of the publishing house Editura Muzicală, Bucharest. On the unchanged form of liturgical majuscule script, see D'Agostino & Martani (2005, 23).cvii|
...
- Three types of display script predominate:

1. The Alexandrian display majuscule script:

used chiefly for titles in mss. with
minuscule pearl-script: see, e.g., the
Menologion of Basil II, Codex Vaticanus graecus
1613, year 979–989:
...
script (upright ogival): see Figure 2.28 and Litsas
(2001, pp. 50–51, 54–57, 62–63, 66–67, 72–73, 76–77).

1. The epigraphic display majuscule script

(elongated): see Figure 2.29 and Litsas (2001, pp. 88–89).

• Another type of majuscule display script
...
ogival).  3. Below: epigraphic (elongated). The excerpts
were copied from the codices: Vindobonensis theologicus
graecus no. 56, f. 120r | Vindob. theol. gr. no. 108, f. 122r |
Vindob. Suppl. gr. 4, f. 5r (for photographs of the original
mss., cf. Hunger, 1995, figs. 40–42).
...
lines are also required, one above and the other below, in order to enclose the strokes or other
features of the letters that extend beyond the central body.”cx
The appearance of Greek minuscule script is dated to the 4th century AD. As
...
Renaissance after the end of Iconoclasm (726–843). Some of the very well-known names of scholars who
played leading roles, in various ways, in the renewal movement of the 9th and 10th centuries are the following: St
Theodore the Studite (759–826), John VII the Grammarian (Patriarch of Constantinople, 836–
842), Leo the Philosopher or Mathematician (ca. 790–after 869), Photius the Great (ca. 810–893?; |
Patriarch of Constantinople between the years 858–869, 877–886), Arethas of Patras (ca. 850–
ca. 944, from 902 Metropolitan of Caesarea in Cappadocia), as well as the emperors of the Macedonian
Dynasty, Basil I the Macedonian (867–886), Leo VI the Wise (886–912), and Constantine VII
Porphyrogenitus (912–959).cxii During this period the transcription (transliteration)
of many works from majuscule into minuscule script took place, often accompanied by critical
editing of the texts, through collation with other manuscripts, and by scholia. As
Mioni emphasizes, “to these copies of the 9th and 10th centuries, written in Byzantium under
imperial or patriarchal auspices, go back the archetypal codices of almost the whole
literary heritage that has reached us from ancient Greece, and very little
would have been preserved from Greek literature had this vehicle not intervened,
which is a creation of the Byzantine Renaissance.”cxiii
Moreover, the transition from majuscule to minuscule script is considered “the most radical
reform” of Greek alphabetic writing in its almost three-thousand-year history. “The
minuscule, the fruit of a slow evolution over the course of centuries, was adopted for the
copying of religious and secular manuscripts, and, passing into
printing, still represents today the normal script of the Greek
language.”cxiv
The developmental course of minuscule bookhand may be divided into various periods
(see Table 2.6).

|Period|Category of minuscule codices|
|---|---|
|9th - 10th c.||
|10th - 13th c.||
|13th - 1453||
...
Table 2.6. Periodization of the development of minuscule bookhand.cxv

At the beginning of its developmental course the minuscule bookhand appears as pure
minuscule, that is, only with small letters—if we except the initials of the various sections of the
text. From the 10th century onward, a slow reintroduction of majuscule characters
into the minuscule script is observed. In its long development and according to place or scriptorium, the
...
• A famous example is the Menologion of Basil II, Codex Vaticanus graecus 1613, year 979–989, from Constantinople:

<http://digi.vatlib.it/view/MSS_Vat.gr.1613/0100> (27.10.2015). Follieri (1969, pl. 20). Litsas (2001, pp. 78–79). See also Figure 2.31.
Figure 2.31. Beginning of Homily 89 of St
John Chrysostom, on the Gospel according to Matthew,
chapter 27, vv. 62–64, in
slightly right-leaning pearl-script, from
Manuscript no. 92 of the Seminar of Classical
Philology of the School of Philosophy of
Aristotle University of Thessaloniki
(containing sixteen parchment folios, 11th c.:
Politis, Sotiroudis and Sakellaridou-
Sotiroudi, 1991, p. 85):
...
- see sample in Litsas (2001, pp. 74–75) and Figure 2.32. Figure 2.32. Letter forms of curly minuscule script, according to the codex Vaticanus graecus, Archivio del Capitolo di San Pietro B 58, f. 201r, 10th c.cxix
...
Vaticanus graecus 463, f. 295r, year 1062 (first
two rows) and Monastery of Sinai, New Finds X 130, 14th
...
the Theologian, Patmos,
Greek 558, f. 113r, year
1648, in
minuscule script
of the “Xeropotamou”
or “Athonite I” type, with
the photagogikon of the plagal
fourth mode.cxlii
...
we can distinguish
various standardized types
of minuscule bookhand,
in the late post-Byzantine
period and modern times,
standardized scripts give
way to the personal handwriting of
each copyist (see, e.g., Figure 2.45).

Excerpt from the
codex of the National
Library of
Greece 964, f. 2r,
autograph of Petros
Byzantios, of the year
1806, with the title of
his Short Heirmologion.c xliv © National
Library of
Greece, Athens.

• For practice in reading

manuscripts in minuscule script
of the 19th c., see the autograph theoretical
texts of Chrysanthos of Madytos and Chourmouzios
...
old habits of copyists, such as ligatures and varied abbreviations, which
accelerated the process of copying and saved space on parchment or on some other writing
material. Table 2.8, based on E. Mioni, records the corresponding categories of graphic
procedures and contains a selection of abbreviations, as an aid for the first steps in reading
Greek manuscripts.cx lv

|Category of graphic procedure|Examples and clarifications|
|---|---|
|1. Contractions: Only the beginning and the end of a word are written, omitting its central part. Used especially in the|ΑΝ(ΘΡΩΠ)ΟΣ ΑΝ(ΘΡΩΠΟ)Υ ΑΝ(ΘΡΩΠ)Ω ΑΝ(ΘΡΩΠ)ΟΝ|
...
and verbs (it is usually placed
slightly higher than the
other letters of the word).
It also appears in prepositions,
conjunctions and adverbs, sometimes
also in frequently repeated
common words (in
this case as a genuine
tachygraphic element).
...
letters) or
ii. combinations (certain elements
from one letter
are also used for the
following letter).cxlvi
...
sciences and arts (e.g.
astronomy, mathematics, psaltic art

etc.) and replace whole

words. Beside are
only a few examples. The
tachygraphic sign for
“monk”/“nun” appears
frequently in musical mss., in
the rubrics.
...
In addition, the so-called reference signs constitute a very interesting case. These make the
connection between the text and related notes placed in the margins (edges) of the folios of the
manuscript, functioning roughly like the asterisks and numbers that we use today for
references. They present a great variety of shapes, such as, for example, small wavy lines, arrows,
keys, and many others, some of which coincide with forms of neumes of Byzantine
notation.cxlviii

### 2.5. Special symbols for the edition of manuscript sources

In preparing editions that are based on manuscript sources, palaeographers use special
symbols that enable the reader to distinguish between those elements that
come from the manuscript source and the others that constitute an intervention by the palaeographer.
The symbols listed below are used chiefly in critical editions
of literary textscxlix and may also be used, with certain adaptations, for the
...
[ ] Square brackets, for an editor’s supplement where some element has been lost in the
original text.

< > Angle brackets, for an editor’s supplement where no element has been lost in the
original text.
...
Braces, for elements that exist in the manuscript in the specific
form, but which should be removed or corrected in the opinion of the editor.

A vertical bar for indicating the end of a line of the manuscript or for marking
a change of folio in the manuscript. In the latter case the number
of the new folio is also given.

A double vertical bar for indicating the end of a paragraph in the manuscript.

Double square brackets, for letters that have been erased in the original text
or for sign-phonemes (σημαδόφωνα) that have been erased and/or are not clearly visible in the original.
...
A number of dots corresponding to the number of letters (with or without musical signs,
depending on the source) that are not clearly visible in the source.

Daggers, marking an erroneous passage that could not be corrected by the
editor (locus desperatus).
...
text lost at the beginning or at the end of a line.

(Lat. = is lacking, are lacking), for words, lines, or neumes that are missing in comparison with another
source.

(Lat. = to be deleted), for letters or words that should be erased.

or in margine (Lat. = in the margin): used to indicate elements recorded
in the margin of the manuscript.

Abbreviation of the Latin word omisit (⁼ omitted).

(Lat. = thus), an adverb used by the editor to confirm a
particular, sometimes perhaps even erroneous, variant or spelling of a source, which
he reproduces exactly in his text.

Abbreviation of the Latin word sci-licet (⁼ it is understood), which is used for
supplementing elliptical phrases of the original.
...
Exercise in majuscule writing 1. The oldest surviving hymn to the Mother of God
...
Noteworthy are the two small curved signs after the word “Theotokos” in the fourth line, the two acute accents at the end of the eighth
...
Catherine on Sinai and today is in the Bohdan & Varvara Khanenko National Museum of Arts. It is one
of the oldest icons of the Virgin preserved to the present day. It is related to the painting of ancient
...
Exercise in majuscule script 2.
The Hymn of Love

1. from the earliest codex of the New

(Codex B), p. 1472, 4th c. (early–mid), in
probably from Egypt:clii <http://digi.vatlib.it/view/MSS_Vat.gr.1209/1476>
...
lower part of the second column, where the arrow is, the beginning of the Hymn of Love (1 Cor. 13:1) is visible.
Source photograph: <http://www.bl.uk/manuscripts/Viewer.aspx?ref=royal_ms_1_d_viii_fs001r#> (8.11.2016).
...
Exercise in majuscule script 3. The oldest witness to the Great
...
Figure 2.48.a. The Alexandrian Codex of the Bible, Londinensis gr. Royal 1 D.vii, fol. 569r (5th c.), in
biblical majuscule script. In the column on the right the “Morning Hymn” (the Great Doxology) is visible, written
“stichērōs” (line by line).clv
Source photograph: Thompson, E. Maunde. (Ed., 1883). Facsimile of the Codex Alexandrinus. London: British
...
Exercise in majuscule script 4. Example from the oldest known
Greek Tropologion (Τροπολόγιο), consisting of two fragments of the New Finds
of the Holy Monastery of Sinai, which originally belonged to the same codex: Greek MS ΜΓ
(=majuscule) 56 (5 folios) and Greek ΜΓ 5 (240 folios), in
sloping pointed majuscule script, second half of the 9th century
...
Exercise in reading and transcribing minuscule script 1. From the
Uspenskij Tetraevangelion, written by Saint Nicholas the Stoudite, in
...
Stoudios, Constantinople. The title is in Constantinopolitan display script (upright pointed
majuscule). On this page the beginning of the Gospel according to Matthew 1:1-6 is visible, with the beginning of the genealogical
...
dated manuscript in pure minuscule script (Studite), written by Nicholas, monk of the Holy Monastery of
Stoudios, Constantinople. On this page an excerpt from the Gospel according to Matthew 16:11-17 is visible.
Noteworthy is the use of a double grave accent on the words “de” and “men”, double accentuation on the word “eipon”, and a wavy
line on the word “Iōannēn” (see Figure 2.53.b). © National Library of Russia, St. Petersburg.
Figure 2.53.b. Copy of the signs which present a
special use of symbols, probably to indicate a specific
...
Noteworthy is the use of a wavy line (known in ekphonetic notation as “syrmatic”) on the words
“two by two” (see Figure 2.54.b). © National Library of Russia, St. Petersburg.
Figure 2.54.b. Copy of the sign with the two “syrmatics” as
...
Exercise in reading and transcribing minuscule script 2. From the Psalter of the
...
Exercise in reading and transcribing minuscule script 3. The Life of Saint
Romanos the Melodist in pearl-script (Perlschrift), from the famous
Menologion of Emperor Basil II, Codex Vaticanus gr. 1613, p. 78, years 979-
989, Constantinople. The title is in Alexandrian majuscule display script:
...
Exercise in reading and transcribing minuscule script 4.
Troparion to the Most Holy Theotokos, which is chanted in the Small and the Great
Paraklesis Canon (Ὡρολόγιον, 2003, pp. 544 and 560), from the Hagiasmatarion (Αγιασματάριο) of the
Seminar of Classical Philology of the Faculty of Philosophy of Aristotle
...
Exercise in reading and transcribing minuscule script 5.
The Introduction to the Theory and Practice of Ecclesiastical Music by
Chrysanthos was a basic teaching manual for learning the New
Method in the years after the Reform of the Three Teachers (1814-15).clx
In the MS of the Holy Monastery of Karakallou 260, from the beginning of the 19th c., fol. 1a, a
...
of ancient Greek, Latin, and Byzantine literature

The Holy Bible and texts

The New Testament. The original text with translation into demotic Greek. (2003). Athens: Hellenic Bible Society.
Saint Theodore the Studite, Ascetic Chapters. Edition of the Men's Holy Monastery of Ano Xenia, 1998.

Herodotus, Histories. Trans. H. Spyropoulos. (1992). Herodotus, Histories. Melpomene-Terpsichore. Athens: Govostis:
...
Menaion for November. (2002). (2nd ed.). Athens: Apostoliki Diakonia of the Church of Greece.
Stephanos the Lampadarios. (Reprint of the 1883 edition). Musical Beehive. Neapolis, Crete: Polychronakis.
Lenten Triodion. (1994). Athens: Apostoliki Diakonia of the Church of Greece.
The Great Horologion. (2003). (15th ed.). Athens: Apostoliki Diakonia of the Church of Greece.

Parenti, Stefano and Velkovska, Elena. (Eds., 1995). L' Eucologio Barberini gr. 336 (ff. 1 - 263). Roma: CLV, Ed.
Liturgiche.
Thompson, E. Maunde. (Ed., vol. I: 1881, vols. II-III: 1883, vol. IV: 1879). Facsimile of the Codex Alexandrinus. 4 volumes
(London: British Museum): facsimile edition of the Alexandrian codex of the Holy Bible, Londinensis gr.
Royal 1 D.v-viii: see <www.csntm.org/Manuscript/View/GA_02> (27.12.2016).
...
National Music.
Chourmouzios Chartophylax. (2007). Introduction to the Theory and Practice of Ecclesiastical Music.
Introduction, critical edition by Emmanouil St. Giannopoulos (2nd ed.). Thessaloniki: University
Studio Press.
Chourmouzios Chartophylax. (2014). Introduction to the Theory and Practice of Ecclesiastical Music.
Ed. Georgios Konstantinou. Vatopedi Music Bible, Musicological Studies 2. Holy and Great
Monastery of Vatopedi.
Chrysanthos of Madytos. (1821). Introduction to the Theory and Practice of Ecclesiastical Music.
Paris: Rigniou. Repr.: Athens: Koultoura.
...
Giannopoulos, Emmanouil. (2016). Basic bibliography on the manuscript codices of Psaltic Art. In E.
...
(1998). Holy Monastery and Archdiocese of Sinai. The New Finds of Sinai. Athens: Ministry of Culture -
...
Stathis, Grigorios. (1989). The differentiation of chant as recorded in codex NLG 2458 of
the year 1336. In Scientific Symposium Christian Thessaloniki - Palaiologan Period, 22nd
Dimitria, P.I.P.M., Monastery of Vlatadon, 29-31 October 1987 (pp. 165-211). Thessaloniki.
Stathis, Grigorios. (2006). The Manuscripts of Byzantine Music, Meteora. Holy Synod of the Church of
Greece - IBM. Athens.
Stathis, Grigorios. (2016). The Autographs of the Exegesis into the New Method of Notation. Volume A.
The Prolegomena & Volume B. The Catalogue. Athens: Institute of Byzantine Musicology.
Chatzigiakoumis, Manolis. (1975). Musical Manuscripts of the Period of Ottoman Rule (1453-1832), volume one. Athens.
Chatzigiakoumis, Manolis. (1980). Manuscripts of Ecclesiastical Music 1453-1820. A Contribution to the Research
of Modern Hellenism. Athens: Cultural Foundation of the National Bank.
Chatzitheodorou, Georgios. (1998). Bibliography of Byzantine Ecclesiastical Music. Period A
(1820-1899). Psaltika Vlatadon 1. Thessaloniki: Patriarchal Institute for Patristic Studies.
...
Books, albums, and articles

Alygizakis, Antonios. (1985). The oktoechos in Greek liturgical hymnography. Thessaloniki: Pournaras.
Alygizakis, Antonios. (1993). Topics in Ecclesiastical Music. Thessaloniki: Pournaras.
Vamboulis, P. (1977). Byzantine Decorative Art. Introduction: Kostas E. Tsiropoulos. Athens: Astir.
Volonakis, E. K. (n.d.). Grammar of the Ancient Greek Language. Athens: Volonakis Publications.
Galavaris, George. (1995). Greek Art. Painting of Byzantine Manuscripts. Athens: Ekdotiki Athinon.
Galavaris, George. (2000). Holy Monastery of Iviron. Illuminated Manuscripts. Mount Athos.
Giannou, Dimitris. (1995). History of Music. A Brief General Survey. Volume A (Up to the 16th century).
Thessaloniki: University Studio Press.
Goulaki-Voutyra, Alexandra. (General responsibility, 2012). Greek Musical Instruments. Investigations in visual and
literary testimonies (2000 BC - 2000 AD). Thessaloniki: Archive of Musical Iconography, Department
of Music Studies.
Gouloulis, Stavros. (2002). Root of Jesse: the complex iconographic type, 13th-18th c.: genesis, development and interpretation
of a dynastic myth. Ioannina: University of Ioannina:
<http://thesis.ekt.gr/thesisBookReader/id/13368#page/706/mode/2up> (31.12.2016).
Detorakis, Theocharis. (1995, 2003). Byzantine Literature. The Persons and the Texts. 2 vols. Heraklion, Crete.
Doxiadis, Euphrosyne K. (1998). From the Fayum Portraits to the Beginnings of the Art of Byzantine
Icons (a contribution to another approach). Heraklion: Vikelaia Municipal Library of Heraklion.
Zografou, Anastasios. (2010). “In sequence,” “parenthetically,” “in itself,” “with enactment.” The preservation of
...
Iconographic Index. Byzantine Monuments 15. Centre for Byzantine Research. Thessaloniki: P. Kyriakidis.
Kalokyris, Konstantinos. (1994). The Canons of Christmas and Easter. The Heirmoi of Theophany.
Text - interpretation - comments - observations. Thessaloniki.
...
Korakidis, Alexandros. (1984). Ancient hymns: 2. The Angelic Hymn (Gloria) “Glory to God in the highest, and on
earth peace...”. Athens.
Litsas, Efthymios. (2001). A Brief Introduction to Greek Palaeography and Codicology. Issue 2. Plates with
selected specimens of scripts and comments. Thessaloniki: University Studio Press.
Litsas, Efthymios. (2011). Introduction to the Study of Post-Byzantine Documents. Facsimiles of Documents with Comments.
Thessaloniki: University Studio Press.
Maliaras, Nikos. (2007). Byzantine Musical Instruments. Greek Musicological Publications, scientific supervisor
Apostolos Kostios. Athens: Papagrigoriou - Nakas.
Mandilaras, V. G. (1980). Papyri and Papyrology. Athens.
Mavropoulou-Tsioumi, Chrysanthi and Galavaris, Georgios †. (2008 and 2007). Holy Monastery of Stavronikita.
Illuminated Manuscripts. From the 10th to the 17th Century. 2 vols. Mount Athos.
Mitsakis, K. (1986). Byzantine Hymnography, from the New Testament to Iconoclasm. Athens: Grigoris.
Babiniotis, Georgios. (2002). Dictionary of the Modern Greek Language (2nd ed.). Athens: Centre for Lexicology.
Bourboudakis, Manolis. (1998). From the Fayum Portraits to the Beginnings of the Art of
Byzantine Icons (a contribution to another approach). Heraklion: Vikelaia Municipal Library of
Heraklion.
Byzantine Music Palaeography Group from the Department of Music Studies of Aristotle University
of Thessaloniki (2007). “With golden words,” a sticheron in honour of Saint John Chrysostom in its
diachronic development: Palaeographical & analytical inquiries. Ed. Maria Alexandru. In First
...
manuscripts in Anastasios-type script and ace of spades. Catalogue of reference elements. Athens.
Ploritis, Marios. (1999). Theatre in Byzantium. Athens: Kastaniotis.
...
Stathis. Athens.
Stathis, Grigorios. (1973). The Cataloguing of the Manuscripts of Byzantine Music of Mount Athos.
Athens.
Tsigaridas, Efthymios. (Scientific ed., 2003). Manuel Panselinos, From the Protaton. Exhibition catalogue.
Catalogue authors Efthymios Tsigaridas et al. Thessaloniki: Agioreitiki Estia.
...
Foundoulis, Ioannis. (1995). Liturgics A. Introduction to Divine Worship (2nd ed.). Thessaloniki.
Chatzidaki, Nano. (1994). Greek Art. Byzantine Mosaics. Athens: Ekdotiki Athinon.
Choulis, Konstantinos. (1999). Byzantine Bookbinding. History, Art and Technique (offprint from the collective
first volume of the periodical publication Vivlioamphistis). Athens: Babis Lengas Bookbinding Workshop.
...
Rouwhorst, & Stefan Royé (eds.), Challenges and Perspectives. Collected Papers, resulting from the expert
meeting of the Catalogue of Byzantine Manuscripts programme held at the PThU in Kampen, the Netherlands on
6th-7th November 2009, Catalogue of Byzantine Manuscripts in their Liturgical Context, Subsidia I (pp. 25-34).
...
publication).
Beltramini, Guido, Gasparotto, Davide and Manieri Elia, Giulio. (2016). Exhibition and corresponding leaflet entitled: Aldo
...
CBM Editors. (2013). The CBM Publication Plan (in cooperation with Brepols Publishers). In Klaas Spronk, Gerard
Rouwhorst, & Stefan Royé (eds.), Challenges and Perspectives. Collected Papers, resulting from the expert
meeting of the Catalogue of Byzantine Manuscripts programme held at the PThU in Kampen, the Netherlands on
...
Escobar, Ángel. (Ed., 2006). El palimpsesto grecolatino como fénomeno librario y textual. Presentación de Dieter
...
Galavaris, George. (1997). The Art of Illuminated Manuscripts on Moun Athos. In Athanasios Karakatsanis (managing
editor), Treasures of Mount Athos, translation Andrew Hendry et al. (2nd ed., pp. 223-259). Thessaloniki: Holy
...
new catalogues. In Klaas Spronk, Gerard Rouwhorst, & Stefan Royé (eds.), Challenges and Perspectives.
...
Liturgical Context, Subsidia I (pp. 281-288). Turnhout, Belgium: Brepols Publishers.
...
Harlfinger, Dieter, Grusková, Jana, Deckers, Daniel and Vanhaegendoren, Koen. (Eds., 2002). Rinascimento virtuale.
...
Mango, Cyril. (2000). Constantinople as the City of the Theotokos. In Maria Vassilaki (ed.), Mother of God. Representations
of the Virgin in Byzantine Art (pp. 17-25). Benaki Museum. Athens - Milan: Skira.
...
Netz, Reviel and Noel, William. (2007). The Archimedes Codex. The Secrets of the Most Important Palimpsest in the
...
PG: Migne. J.-B. (Ed.). Patrologiae cursus completus. Series graeca. (Paris, 1857 ff.).
...
Royé, Stefan. (2013). The coenobitic Typikon and principles of liturgical codex composition. The liturgical context of the
collection of Byzantine manuscripts of Mone Karakallou. In Klaas Spronk, Gerard Rouwhorst, & Stefan Royé
(eds.), Challenges and Perspectives. Collected Papers, resulting from the expert meeting of the Catalogue of
Byzantine Manuscripts programme held at the PThU in Kampen, the Netherlands on 6th-7th November 2009,
Catalogue of Byzantine Manuscripts in their Liturgical Context, Subsidia I (pp. 235-270). Turnhout, Belgium:
Brepols Publishers.
...
Sautel, Jacques-Hubert. (Ed., 1995). Répertoire de réglures dans les manuscrits grecs sur parchemin. Base de données
...
<http://digi.vatlib.it/view/MSS_Vat.gr.1209> and <http://digi.vatlib.it/view/MSS_Vat.gr.1209/1476> (25.11.2015).
<http://digi.vatlib.it/view/MSS_Vat.gr.1613/0100> (27.10.2015).
...
|depictis". Cf. also Alygizakis (1993,|
||

i Cf. Mioni (1998, 13), in conjunction with
Chatzigiakoumis (1980).
ii Cf. Dölger & Karayannopulos
iii Cf. Bagnall (ed., 2009).
iv Initially, the interest of palaeographers
manuscript codices up to and including the 17th century (Late
Renaissance). With the passage
of the science of Palaeography, its field of research
is constantly extending toward
Litsas (2001, 132-135). By the same author (2011, especially
documents nos. 22 and 46). <http://el.wikipedia.org/wiki/Αναγέννηση> (7.4.2015).
v See Mioni (1998, pp. 14-16).
vi See Montfaucon (1708, p. 358):
...
pp. 21-22).
vii Mioni (1998, p. 14).
viii Babiniotis (2002, p. 978). <http://en.wikipedia.org/wiki/Codex> (7.4.2015).
ix Mioni (1998, pp. 18-24). Canart (1991). Lemaire (1989). Sautel (ed., 1995). Choulis (1999). Agati (2003). Maniaci
(2002). The Latin saying Habent sua fata libelli (Books have their fortune/fate) comes from the grammarian
Terentianus Maurus (2nd c. AD): cf. West (1973, p. 7) and <http://latin-quotes.blogspot.gr/2010/05/habent-sua-fata->
libelli.html (15.2.2016).
x Cf. Bülow-Jacobsen (2009, p. 4, table 1.1 and passim).
xi The present section is based on the following bibliography: Mioni (1998, pp. 28-32). Latacz (2014). Bagnall (ed., 2009).
Mandilaras (1980). Turner (1989). For the books by Mandilaras and Bagnall we warmly thank our student
Sister Parthenia (Chrysoula Kaltsa).
Cf. also
<http://de.wikipedia.org/w/index.php?title=Datei:Papyrus,_Fonte_Aretusa,_Syracuse,_Italy.JPG&filetimestamp=2007123>
...
The manufacture of papyrus and its various qualities (from the luxurious charta hieratica [later called
augusta] to the cheaper charta emporetica) are described by the Latin author Pliny the Elder
(1st c. AD), in his work Historia naturalis (XIII, 74-82): Mandilaras (1980, pp. 40-43: text,
translation, comments) and Mioni (1998, pp. 28-29: summary).
xvii Cf. Bagnall (ed., 2009, pp. xviii, vi). Latacz (2014, pp. 18-20).
xviii See Hunger (1961, p. 63). <https://www.britannica.com/topic/Library-of-Alexandria> (14.2.2017).
xix See Mioni (1998, pp. 30-31).
xx For more details, cf. Latacz (2009, p. 22). Cuvigny (2009).
xxi See Mioni (1998, p. 31).
xxii See Kouremenos, Parassoglou & Tsantsanoglou (2006). Latacz (2014, p. 21). See also
<http://ancphil.lsa.umich.edu/-/downloads/faculty/janko/reconstructing-again-derveni.pdf> (8.8.2016).
xxiii For the caption, see also data from:
<https://el.wikipedia.org/wiki/Πάπυρος_του_Δερβενίου#/media/File:Derveni_Papyrus_->
_Fragments_on_display_in_the_Archaelogical_Museum_of_Thessaloniki.jpg (8.8.2016).
<http://www.hellinon.net/ArxaioteroBiblio.htm> (8.8.2016).
xxiv Cf. also the research programme Papyrus Portal:
<http://www.organapapyrologica.net/content/papportal_start.xed?XSL.PortalType.SESSION=papportal> (8.8.2016).
xxv See Latacz (2014, p. 22).
xxvi The present section is based on the following bibliography: Mioni (1998, pp. 32-37). Bülow-Jacobsen (2009, p. 11).
Hunger (1995, pp. 22-27).
xxvii See the testimony of Herodotus (5th c. BC, Histories, 5.58.3): “And the Ionians have called books skins from
of old, because once, when books were scarce, they used goat and sheep skins; and even in
my time many of the barbarians write on such skins.” (Mioni, 1998, p. 32). Hornblower & Spawforth
(eds., 2003, pp. 696-698: 696). See also
<www.greek-language.gr/digitalResources/ancient_greek/library/browse.html?text_id=30&page=131> (30.1.2017), where
there is also the translation (Spyropoulos, 1993) of the above passage: “Likewise, the Ionians from ancient times call books
diphtheres, because once, when papyrus was scarce, they wrote on processed skins of goats and sheep -
even in my own day many of the barbarians write on such skins.”
xxviii In an 8th-century AD codex preserved in the Italian city of Lucca, there is the following recipe: “How
parchment should be made. Put it in lime and let it remain there for three days.
Then keep it in a basin of water. Scrape it with a razor on both sides and
leave it to dry. Then, as often as you wish, you can scrape its surface. Then with
pumice remove the hair and sinews completely. For if you do not do this, the letter that will be
written on it will not be readable and will not be able to last for long.” (Mioni, 1998, p. 34). The
suitable preparation of parchment makes possible the writing of text on both of its sides, which were
called hair side (the outer side) and flesh side (the inner side). See also
...
<https://el.wikipedia.org/wiki/Πλίνιος_ο_Πρεσβύτερος> (30.1.2017).
<https://el.wikipedia.org/wiki/Μάρκος_Τερέντιος_Βάρρων> (30.1.2017).
xxx Hornblower & Spawforth (eds., 2003, pp. 567-568 [Eumenes], 1582 [Varro]).
xxxi These are Aramaic parchment documents from Bactria, near the Caspian Sea (Bülow-Jacobsen,
2009, pp. 11, 29). Cf. also <https://el.wikipedia.org/wiki/Ελληνικό_βασίλειο_της_Βακτριανής> (15.2.2016).
xxxii See also Tsolakidis (2001, p. 742).
xxxiii Cf. <http://deutschland-im-mittelalter.de/Epoche/Karolingerzeit> (30.8.2016).
xxxiv Cf. Mioni (1998, pp. 35-36), where, among other things, the following examples of purple codices of the
6th century with texts of the Holy Bible are mentioned: the Vienna Genesis (Vindobonensis theol. gr. 31), the codex Petropolitanus
N (Bibl. Publ. 537, with leaves scattered in many parts of the world, e.g. one leaf is in the Museum
of Byzantine Culture in Thessaloniki) and the codex Rossanensis (Archiepiscopal Museum of Rossano, in
Calabria, Italy).
...
2. sorting the linen rags,

3. soaking them in hot water and creating a thick pulp,
...
xxxix The tradition of watermarks was begun by Italian papermakers. To this day luxury paper may
bear various watermarks. The process of producing watermarks is described by Mioni (1998, p. 40).
xl For the paper we thank Mr Konstantinos Angelidis; for the photograph Mr Stefanos Alexandrou.
xli Briquet (1907): <https://doc.rero.ch/record/23217/files/ob_447_1.pdf> (15.2.2016). We thank Mr Adrian Sîrbu
for this electronic address. See also Mioni (1998, p. 41), where various other repertories
of watermarks are also mentioned. Cf. also <http://abacus.bates.edu/wmarchive/> (8.8.2016) and
<http://www.ksbm.oeaw.ac.at/_scripts/php/BR.php?lang=de> (8.8.2016).
xlii See Mioni (1998, pp. 42-43).
xliii Cf. Dölger & Karayannopulos (1968, pp. 28-30 and p. 171, no. 68, with the corresponding plates). Hunger (1995, pp.

110-114, 155-158. For further bibliography on this topic, cf. Alexandru (2011, p. 329, n. 26).

xliv Cf. Babiniotis (2002, p. 1555).
xlv Cf. e.g. Chatzigiakoumis (1980, parts D-E). Galavaris (2000).
xlvi For the photography we thank Mr Demosthenes Spanoudakis. For an analytical description of this codex
and publication, among other things, also of f. 11r, cf. Stathis (1989, pp. 202-203, pls. 3-4. For the headpiece, see ibid., p.

170). Cf. also the Anastasimatarion-Anthology of Panagiotis Chrysaphes the New, ms. Holy Monastery of Xenophon, no.

128, year 1671, “one of the most beautiful manuscripts of Byzantine music,” in Stathis (1997, pp. 636-638, fig. 21.6). For
more data regarding this ms., cf. Stathis (1976, pp. 57-68).
xlvii Tsigaridas (scientific ed., 2003, p. 148, fig. 34 and p. 48 [dating]).
xlviii Cf. Mioni (1998, p. 45).
xlix See Hunger (1995, p. 31).
l Cf. Bülow-Jacobsen (2009, pp. 11-13).
li Cf. Mioni (1998, pp. 47-48). Hunger (1995, p. 34).
lii Cf. You are not alone 5/10 - Basil the Great - You Tube:
<https://www.youtube.com/watch?v=7lkSNEz_4Ck&index=8&list=PL7YB-qFjmA2FBeShTXBu4USGttKuTpqww>

(9.1.2017). We thank Mr Emm. Giannopoulos for the link.

liii Cf. Mioni (1998, p. 98). Hunger (1995, p. 176).
liv Detorakis (2003, p. 421). For the Holy Monastery of Saint John the Baptist, founded by the senator
Stoudios in the year 463 in Constantinople, cf. Mathews (1980, p. 19).
lv PG 99 (Migne [ed., 1903], pp. 1740 C-D, from: Detorakis [2003], p. 438). “If he does not hold the quire carefully and
does not place the book from which he is copying (perhaps he means on the lectern), and does not cover both at the appropriate time and
does not follow attentively the corresponding lines of the text (?), the accents and punctuation marks, he is to make
30 and 100 prostrations. (...) If the chief calligrapher distributes the handiworks with partiality and does not properly protect the
parchments and all the tools for decoration, so that none of the things needed in
this service may become useless, he is to make 50 and 100 prostrations and you shall rebuke him with excommunication.” Cf. also Saint Theodore the
Studite, Ascetic Chapters, pp. 41-42. See also Mioni (1998, p. 98).
lvi The diagrams were copied with tracing paper and translated on the basis of: Lemaire 1989, pp. 70-71). In modern
bibliography concerning analytical descriptions of Byzantine and post-Byzantine musical manuscripts
...
lx The diagrams were copied from: Sautel (1995, p. 39). The description of the
lxi

lvii

diagrams is based on: ibid., pp. 76 and 80.
For more data and photographs regarding the individual stages of Byzantine bookbinding, cf.
Choulis (1999, pp. 19-56). Cf. also <http://byzantinidiadromi.blogspot.gr/2014/02/blog-post_12.html> (30.8.2016).
lxii The copy was based on a photograph from: Hunger (1995, p. 44, fig. 9, and pp. 43, 46-47). For the monogram of the
Palaiologoi, cf. also Choulis (1999, p. 38, fig. 35).
lxiii The description of this binding was based on: Hunger (1995, p. 48). Cf. also
<http://digital.lib.auth.gr/record/80082/files/1.pdf> (22.8.2016) for a fine specimen of bookbinding in a post-Byzantine
liturgical book.
lxiv For a luxurious 10th-century binding, probably from Constantinople, which is kept in the Marciana
Library in Venice, having a binding with gold, pearls, precious and semi-precious stones and small icons
...
Galavaris (1997). Mavropoulou-Tsioumi & Galavaris (2008 and 2007). Vamboulis (1977).
lxvii

The present section is based chiefly on the following aids: Mioni (1998, pp. 51-53). Hunger (1995, pp. 25-27).
Harlfinger, Grusková, Deckers, & Vanhaegendoren (eds., 2002). Faraggiana & Magrini (eds., 2002). Escobar (ed.,
2006).
lxviii See Latacz (2014, p. 21).
lxix See Liddell, Scott, Jones, & McKenzie (1990, p. 2019). Babiniotis (2002, p. 249).
lxx See details in Mioni (1998, p. 52). Cf. also the depiction of the process of making palimpsest
leaves in Harlfinger, Grusková, Deckers, & Vanhaegendoren (eds., 2002, p. 31, fig. 1).
lxxi Cf. Hunger (1995, pp. 25-27).
lxxii See Faraggiana & Magrini (eds., 2002, pp. 13, 24, 26, 31).
lxxiii See relevant photograph in Harlfinger, Grusková, Deckers, & Vanhaegendoren (eds., 2002, p. 112, fig. 12).
lxxiv See especially the photographs in Faraggiana & Magrini (eds., 2002, p. 12).
lxxv Cf. <http://www.sinaipalimpsests.org/technologies> (1.9.2016), as well as Easton and Kelbe (2014). In the latter
article reference is also made to the processing technique concerning the spectral unmixing
of the two scripts in photographs of palimpsests, to the statistical analytical methods Principal Component Analysis
...
double musical script. On f. 109r of this codex, the upper script contains a Kontakarion from Southern Italy
(Calabria-Sicily area), 13th-14th c., in minuscule script of the Reggio type and Middle Byzantine musical
notation. In the lower script there appears an Italo-Greek Sticherarion from the beginning of the 12th c., with
hymnographic text in minuscule script of the Rossano type and Old Byzantine musical notation of the
Hagiopolitan, relatively developed type: cf. photograph and description in Bucca (2011, pl. 50 and pp. 186, 188,
189, 198). For other Byzantine musical palimpsests, see Bucca (2011, pp. 204-216 & pls. 52-53 [Messan. gr. 129], pp.

216-225 [Messan. gr. 152], pp. 229-234 [Messan. gr. 161+175.VII]). Martani (2005, p. 250, pls. 2-3 [Crypt. B.b. III, f.

189v, 192v]. Moran (1985). Raasted (1992). Alexandru (2006, pp. 121-130).
For a modern research programme concerning the palimpsests of the Library of the Holy Monastery of Saint Catherine, Sinai,
cf. <http://www.sinaipalimpsests.org/node/24> (19/8/2016).
lxxvii “On 29 October 1998, the front page of the New York Times reported that a quite unattractive book had
just been sold at a Christie's auction for 2,000,000 dollars. Apparently it was the
worn prayer book of John Myronas, a Greek monk who lived in Jerusalem in the 13th century AD.
...
imaging techniques, whose origins derive from the thought of Archimedes himself!—the hidden,
and partly unknown contents of this palimpsest are coming to light (...) radically changing our understanding of the
history of mathematics.” (Netz & Noel, 2007, text on the folded cover). Photographs of the codex and of the
process of reading it are found between pp. 178-178 of the aforementioned book. For the making of the
palimpsest, see pp. 140-145. See also Netz, Noel, Tchernetska, & Wilson (eds., 2011). For pointing out this
book I thank Mr Erik Petersen.
lxxviii This is a codex of the Holy Bible in Greek, with underlying majuscule script of the 5th century, and
overlying minuscule script of the 12th/13th century, with works of Saint Ephrem the Syrian, also in Greek.
For details see <http://gallica.bnf.fr/ark:/12148/btv1b8470433r/f14.image> (17.12.2014).
<http://www.skypoint.com/members/waltzmn/ManuscriptsUncials.html#uC> (17.12.2014).
<http://www.skypoint.com/members/waltzmn/Correctors.html> (17.12.2014). See also Figure 4.5 of the present
handbook. We thank Fr Filothei Bălan for pointing out this palimpsest codex.
lxxix See the ambitious research programme "Catalogue of Byzantine Manuscripts (CBM) in liturgical context:
revisiting the handwritten monuments of Byzantine heritage in their present-date state of delivery" (Spronk, Rouwhorst,
& Royé, 2013, p. 289), which begins from the observation that "The presence of a great number of Byzantine liturgical
...
formal instructions." (Royé, 2013, p. 250). Cf. also the more general meaning of the term typikon, as a “framework
of liturgical regulations which determine the liturgical life of the church both with regard to its general principles
and with regard to its details” ("a framework of liturgical regulations that determines the liturgical life of the
Church, both in its general principles and in its details": Alexopoulos, 2013, p. 25, and table of historical development of the
Typikon, on p. 31).
lxxxii The present diagram is based on Royé (2013, pp. 250, 257-260, especially on diagram 2 on p. 260), as well as on
Table 1.6 of the present work, together with its bibliography. See also CBM Editors (2013, pp. 298-313). Marcello
Garzaniti (2013) emphasizes that "The greater part of the manuscript heritage of the Christian East has liturgical or
...
church, but for a historical community, a church or monastery" (p. 283).
lxxxiii See especially Stathis (1973) and idem (1975, pp. xxi-lxxviii). In general, see Stathis (1975, 1976, 1993, 2016) and
idem (2006 as well as 2016).
lxxxiv The catalogue of Bucca (2011) is structured in this way.
lxxxv Cf. Mioni (1998, pp. 56-57).
...
London, British Library, dating: 685-705, in minuscule Byzantine cursive script of documents
(Litsas, 2001, pp. 46-47).
lxxxix The copy was based on: Hunger (1995, p. 154, pl. 43 and p. 191, with reference to: Lemerle et alii [eds.,
1970], Actes de Lavra, I, Paris, no. 33/III = pl. XXXI).
xc The present table is based on: Mioni (1998, pp. 59-61, 77-80). Litsas (2011, p. 9).
xci See Mioni (1998, p. 57).
xcii See Floros (1998, p. 115).
xciii See Mioni (1998, p. 58).
xciv See Mioni (1998, p. 58). We can observe the original function of the letter H in Latin and
the other alphabets which developed on its basis (e.g. English), where the character H continues
to indicate a strong aspiration. For more historical data, cf. Threatte (1996, p. 276).
xcv The present table is based on the following aids: Floros (1998, pp. 115-116). Mioni (1998, pp. 58-59). Threatte
(1996, pp. 276-278). Babiniotis (2002, pp. 256, 1040). Bornemann & Risch (1978, pp. 5, 22). Cf. however also Høeg
(1935, p. 39), regarding the historical development of prosodic signs, specifically the reform of
the grammarian Theodosius, during the 4th c. AD.
xcvi In seeking the “method of liturgical reading” and, more generally, the tradition of reciting Greek
texts, A. Zografou (2010) observes, among other things, the following interesting points:

 “The use of punctuation marks differs substantially from manuscript to manuscript” (p. 214).

“The examination of the manuscripts shows that there was not, as also in the case of the ekphonetic signs, a
...
10th century) in his scholia on homilies of Saint Gregory the Theologian (p. 215) and leads to the conclusion that “the
loud reading of the orations of St Gregory the Theologian is situated in
continuation of the epic and theatrical tradition of ancient Greek literature; it constitutes
its substantial and living continuity” (p. 216). The system of Nicanor is attested in
...
is determined by the preceding one and determines the following one. Byzantine notation,
like ancient discourse (...) is based on a prosodic model of recitation; it is first
...
xcvii Mioni (1998, pp. 56-57).
xcviii Mioni (1998, p. 77).
xcix For the lyric poet Bacchylides (ca. 520-450 BC), see Hornblower & Spawforth (eds., 2003, p. 230).
...
photograph 49).
civ Cf. Mioni (1998, pp. 74-75 and pls. VII-VIII).
cv Cf. Mioni (1998, pl. VIII and p. 166).
cvi L΄ Eucologio Barberini 336 (ed. Parenti & Velkovska, 1995). Foundoulis (1995, p. 80).
cvii “Liturgical majuscule script shows no internal development over time, and seems, in some way,
to be inspired by the stability of the icon” ("la maiuscola liturgica non presenta alcuna evoluzione
interna nel tempo, e sembra quasi ispirarsi alla fissità dell' icona": D' Agostino & Martani, 2005, p. 23).
cviii The point of departure for the present table is the following books: Mioni (1998, pp. 63-45 and pls. I-IX). Litsas (2001, pp. 12-45). For
the select scripts, see Hunger (1995, pp. 149-152).
cix This section is based on the following bibliography: Mioni (1998, pp. 77-92). Litsas (2001, pp. 46-135.
cx Mioni (1998, p. 56).
cxi The codex Vaticanus gr. 2200, of the 8th/9th c., is mentioned as the oldest manuscript in which the cursive script is used for copying a literary text: Mioni (1998, p. 79). Litsas (2001, pp. 48-49).
cxii See Mioni (1998, pp. 85-87). Detorakis (2003, pp. 421-446, 517-519, 537-580). Buchwald, Hohlweg, & Prinz (1982, pp.

1. -75, 379-380, 638-641). Karagiannopoulos (2001, pp. 142-158). Mango (ed., 2002, pp. 214-247). Cormack (2000, pp.

104-142).

cxiii Mioni (1998, p. 88). For the transmission of ancient Greek texts cf. also Irigoin (1997).
cxiv Mioni (1998, p. 82).
cxv The present table has as its point of departure: Mioni (1998, pp. 80, 82).
cxvi Studite script is pure minuscule. According to Mioni (1998, pp. 80, 88-92), minuscule
scripts from the middle of the 10th century onward are mixed, with increasing proportions of majuscule characters,
the use of which depends on the personal preference of each scribe. It must also be pointed out that the
boundaries between pure and mixed minuscule script are not absolute: cf. e.g. the reference to
“minuscule, almost pure, of Greek-Lombard type” script of ms. Vat. gr. 2138 (Litsas, 2001, pp. 66-67).
Regarding the “Anastasios-type” script that appears from the end of the 9th century, research must be extended
to the special bibliography cited in: Papathanasiou (2013, pp. 27-28, n. 23).
cxvii For more data concerning this ms., cf. Mioni (1998, pl. XI and p. 84).
cxviii Mioni (1998, pp. 90-91).
cxix Copy based on: Litsas (2001, pp. 74-75. See also ibid., pp. 62-63).
cxx Copy based on: Litsas (2001, pp. 72-73).
cxxi The letters were copied from the photographs of texts found in: Litsas (2001, p. 83) and in Archbp.
Damianos, Archim. Sophronios, Peltikoglou and Nikolopoulos (1998, photograph 180). In both cases, the
letter “ψ” was absent from the corresponding texts and for this reason could not be included in the
alphabetic series.
cxxii Cf. Litsas (2001, pp. 86-87).
cxxiii Cf. Papathanasiou (2013, p. 27).
cxxiv Cf. Litsas (2001, pp. 76-77, 92-93, 102-103).
cxxv Cf. Mioni (1998, p. 91). Litsas (2001, pp. 76-77).
cxxvi Later, the same sticheron was incorporated into the celebration of Saint John Chrysostom on 13 November:
cf. Troelsgård (2003), p. 8, no. 221. Menaion for November (2002, p. 240). For the diachronic musical development
of this sticheron, see also Byzantine Music Palaeography Group from the Department of Music Studies of
Aristotle University of Thessaloniki (2007): <http://www.asbmh.pitt.edu/page9/page10/page10.html>
...
cxxx Image from: <https://commons.wikimedia.org/wiki/File:Chora_Church_Constantinople_(6).JPG#/media/> (16.2.2016).
...
in the 9th century AD, cf. <http://www.bl.uk/treasures/gutenberg/homepage.html> (21.07.2015). See also
<https://el.wikipedia.org/wiki/Γουτεμβέργιος> (21.07.2015).
cxxxiv Cf. Mioni (1998, p. 92, and n. 27 on p. 152, with further bibliography on Greek typographic
characters).
cxxxv Cf. Litsas (2001, pp. 122-125).
cxxxvi For the biographical data of Aldus Manutius, cf. <http://www.britannica.com/biography/Aldus-Manutius-the->
Elder (21.07.2015). The rich publishing work of Manutius and other publishers within the cultural contexts
of 15th- and 16th-century Italy was the subject of an exhibition in Venice, entitled: Aldo Manuzio. Il rinascimento di
Venezia, Venezia Gallerie dell' Accademia, 19 marzo - 19 giugno 2016, a cura di Guido Beltramini, Davide Gasparotto,
Giulio Manieri Elia (see also the corresponding exhibition leaflet). Cf. also
<https://el.wikipedia.org/wiki/Άλδος_Μανούτιος> (21.07.2015).
cxxxvii For the caption, cf. Mioni (1998, p. 169).
...
cxlii Copy and caption based on: Litsas (2001, pp. 130-131). We copied in red the indications of the kind
of melourgia and of the mode, as well as the initial of the troparion. For the hymnographic text of the photagogikon, cf.
...
<http://www.oodegr.co/english/ekklisia/oldest_theotokos_prayer.htm> (17.4.2015).
cli See Bourboudakis (1998, pp. 7-13. For the Fayum portraits, cf. also Doxiadis (1998).
clii The specific page also exists in printed black-and-white form in: The Sacred Books (Vatican, 1965). See also
Karavidopoulos (2001, p. 42). Other specimens in printed form from the same codex are found in: Follieri (1969, pl.

1) and Litsas (2001, pp. 14-15).

cliii The provenance of the manuscript is not clear: see Litsas (2001, p. 18) and
<www.bl.uk/manuscripts/FullDisplay.aspx?ref=Royal_MS_1_D_VIII> (27.12.2016).
cliv For a description of the ms. and other specimens, cf. Litsas (2001, pp. 18-19). Cf. also the facsimile
edition of the Codex Alexandrinus by Thompson (1879).
clv Ff. 569r-v were also published in Korakidis’s monograph on the Great Doxology (1984, photocopy
plates 1-2). For the description of the codex, cf. Litsas (2001, pp. 18-19). Metzger (1981, pp. 86-87). Milne & Skeat
(1955, pp. 30-40). For the Great Doxology on an ostracon of the 6th or 7th century, with the Trisagion at the end, cf. Mihálykó
