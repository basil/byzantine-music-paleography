---
title: "Chapter 9 – Middle Byzantine Notation (III): Metrophony – Parallage – Melos, the Didactic Triptych of the Old System"
weight: 90
---

Summary
This chapter focuses on issues concerning the manner of teaching in the Old System. More
specifically, it deals with the concept of metrophony (μετροφωνία), that is, the quantitative measurement of individual
intervals, musical lines, and entire pieces, in conjunction with parallage with
polysyllabic pitch names, and with the transition to melos, i.e. the traditional sonic result. The
sources on which this chapter is based consist of theoretical manuals, lists of signs, and
didactic poems. A central place is occupied by the methods “Choros tetradekapyrseutos” and “Theologe
parthene”. In connection with the latter, reference is also made to the question of chromaticism in the practice and
theory of medieval psalmody.
...
pitch names to each note sign, and 2. Melos, with the pronunciation of the syllables of the text on each
pitch sign (see Figures 9.1.-2).

![Description](image_10510.jpeg)

Figure 9.1. The process of learning pieces in the New Method: parallage and melos.
Source: Chrysanthos of Madytos (1821). Introduction to the Theoretical and Practical Aspects
of Ecclesiastical Music. Paris: Rigniou (repr. Koultoura), p. 11.

![Description](image_10511.jpeg)

of ecclesiastical

Figure 9.2. Example of parallage in the New Method.
Source: Chrysanthos of Madytos (1821). Introduction
to Music. Paris: Rigniou (repr. Koultoura), p. 9.
...
Figure 9.3. The didactics of the Old Method, according to Chrysanthos: parallage - metrophony - melos, with the
example of the first phrase of the resurrectional sticheron of the first mode “Our evening prayers”, text by Saint
John of Damascus (c. 675 - c. 753/4),i melos by Panagiotes Chrysaphes the New (“fl. c. 1650-1685”).ii
Source: Chrysanthos of Madytos (1832). Great Theoretical Treatise on Music. Ed. P. Pelopides. Trieste: Michael
Weis (repr. Koultoura), pp. xlvi-xlviii, §§ 70-73.

The triptych parallage (a kind of solfège with the polysyllabic pitch names ananes, neanes, etc.) -
metrophony (performance of the voiced signs of the old stenographic notation with a basic
rhythm) - melos (full rendering of the melodic content of the formulae, on the basis of oral tradition), in
Chrysanthos’s description, constituted the didactic model in the Old System, as it had matured
...
Figure 9.4. Stages in the career of a 15th-century chanter, according to Gabriel Hieromonachos.iii

Attempting to interpret the statements of Gabriel Hieromonachos through a more general
consideration of Middle Byzantine notation (practical sources, theoretical writings, and the present-day
tradition of psalmody), we observe that the first two elements mentioned by the great
late Byzantine theorist concern the level of the structure of the pieces, whereas the elements beyond these,
which characterize the perfect chanter, point to the level of performance and are related to the
musical-liturgical process itself (see Table 9.1).

Level of - Concerns intervallic articulation.
structure: the - It is written by means of:
“quantity” • the ison and the voiced signs,

• the martyria.

M - It is learned by means of:
U • metrophony,
S • parallage.
I Level - Concerns musical formation (Gestaltung) in the domains:
C of performance: • time → rhythm, tempo,
A the “quality”
L • intervallic space (pitch), → shapings-ornamentations of various levels (from
small breaks of the voice up to large and
P complex transformations of the melodic
I skeleton), modulations,
E • expression → dynamics, articulation, timbre, phrasing, ethos.
C
E - It is indicated by means of cheironomy:
• hand shape,
• graphic representation: especially the
great signs of cheironomy.

- It is decoded traditionally through EXEGESIS.
...
Another schematic representation of the triple didactic progression according to the Old Method could
also take the following form (see Figure 9.5):

Figure 9.5. Metrophony-Parallage-Melos and other key concepts in the Theory of Psalmody according to the Old Method.

In order, however, for the key concepts metrophony, parallage, cheironomy, exegesis,
...
uses. We saw in chapter 6 that the final stages of Paleo-Byzantine notation
...
Figure 9.6. The course of Byzantine notation from adiastematicity toward diastematicity.
Sources: Floros (1970, vol. III, p. 48). EBE 2458, year 1336, fol. 3r, excerpt from the Mega Ison of Saint John
Koukouzeles.v

The critical step toward diastematicity (Strunk, 1966, p. 1) was made within a symbolic
graphic system (Doda, 1995, p. 65), in contrast to Western music, where the analogous step
was made through the exploitation of the vertical axis of writing and the introduction of lines, leading toward the
formation of the staff (Figure 9.7).

![Description](image_10667.jpeg)

Figure 9.7. Diastematicity in East and West: symbolism (“conventional signs on a horizontal line”) and
iconicity (indication of pitch on the basis of a vertical axis).
Sources: Copies from Petropolitanus gr. 495, fol. 2v, first half of the 13th c., and Parisinus lat. 10508 of the National Library
of France, fol. 6r, 12th c., from the Benedictine Abbey of Saint-Evroult d'Ouche, with “French neumes of the second
epoch” and lines added later, of two kinds: 1. lines incised in the parchment with a
...
process of quantitatively determining the intervals of psalmody, with the second as the unit of measurement. As a
result, an interval of four voices corresponds to the interval of a fifth in the theory of
...
- Numerical, with the indication of the intervallic value beside or beneath the sign (see Figure

1. , the red circles, and Figure 9.8),

- verbal, with a relevant clarification beside the sign (see Figure 9.9).

![Description](image_10668.jpeg)

Figures 9.8-9. Numerical and verbal indications of the intervallic value of the pitch signs in the Protheoria of the
Papadike. Left: beneath the combinations with the ison: “voiceless”, and then indications for 1 or 2 voices. Right:
“the oligon, one”, etc.
Sources: Copies of excerpts from the Protheoriai of the mss.: left: Jerusalem, Patriarchate, collection of the Holy Monastery of
Sabbas the Sanctified, ms. 602, fol. 11r, 14th c. (Papadopoulos-Kerameus), right: Holy Monastery of Iviron 970, fol. 2v, year 1686,
autograph of Kosmas Makedonos (Stathis).vii

#### 2.2.2. Metrophonia (μετροφωνία) in didactic poems
...
##### 2.2.2.1. “A choir lit by fourteen torches” (Χορός τετραδεκαπύρσευτος): an example of metrophony (μετροφωνία), parallage (παραλλαγή), and melos (μέλος) in a diatonic mode

Taking as his point of departure the idiomelon of the Old Sticherarion “A choir lit by fourteen torches” in the first mode, in honour of the Holy
...
Figures 9.10-11. “A choir lit by fourteen torches” and other stichera in honour of the Holy Forty Martyrs of
Sebaste (early fourth century AD. Commemorated on 9 March), from the Sticherarion of NLG 884, fol. 155v, year 1340/41, in
Middle Byzantine, fully developed notation. © National Library of Greece.

 Seventeenth-century portable icon with the martyrdom of the Holy Forty Martyrs.
...
Figure 9.14.a. The exegesis by Chourmouzios Chartophylax of the old sticheron “A choir lit by fourteen torches,” in
...
based on the autograph MPT 709, fol. 104v.

Proceeding to a comparison of all the aforementioned sources, we observe the direct
...
a poem by Theophanes (NLG 884) or by the Studite (A 139 sup.): see Figures 9.16-17.

![Description](image_10676.jpeg)

Figure 9.16. The sticheron “O Virgin Theologian,” in mode 2, from the Old Sticherarion corrected by Saint
John Koukouzeles, MS NLG 884, fol. 37r, year 1340/1. © National Library of Greece.xii
Listen to the metrophonic and rhythmic structurexiii of the sticheron (chromatic version), by clicking .
Clarification: The recording was based on Ambrosianum A 139 sup., fol. 23v (from the facsimile edition of Perria
& Raasted, 1992, MMB Facsimiles XI), which has the same emphōna signs (only at the word blabēs is there a petaste instead
...
Listen to the parallage and the melos of the exegesis by clicking  & .
...
Figure 9.18.b. Continuation and conclusion of Chourmouzios’s exegesis of the sticheron “O Virgin Theologian,” based on
his autograph MPT 707, fol. 222v-223r.

Comparing the three sources above (Figures 9.16-18) with one another, one observes that the
original old sticheron and the exegesis are in the chromatic genus. For the New Method this is apparent
straightforwardly from the martyriai and phthorai. For the Old System, the element of chromaticism (that is,
the presence of an augmented second within the mode) is inferred from the use of the martyriai. A comparison
of the piece in the Old Sticheraria NLG 884 (fol. 37r), A 139 sup. (fol. 23v, year 1341), and Copenhagen NkS
4960 (fol. 22r-v, fourteenth century) shows that all the medial martyriai belong to the family of mode 2.
The use of the martyria for the mesotēs of mode 2 in the old notation implies a structure of
similar diphonies.xvi It follows that the pitch G will be sharpened: the first diphony of the mode, E F G#, will
show a similarity (though not identity) with the second diphony, G# a h.
Nevertheless, the sticheron for parallage in codex NLG 928, fol. 167r-v, uses beneath the
pitch signs of the metrophony the martyriai according to the system of tetraphony, that is, of the trochos. For the pitch
G it sets the martyria . It follows that here the pitch G will be natural.

![Description](image_10681.jpeg)

As mentioned in chapter 8, section 3.5, this contradiction leads us to a very interesting
phenomenon of the old notation, which various theorists such as Chrysaphes the Elder (verses 438-452)
and the Anonymous theorist of MS NLG 968 (fol. 167r) interpret through the antithetical conceptual
pair “from parallage” - “from melos.”xvii During the Byzantine and early post-Byzantine period,
a form of parallage predominates that is based entirely on the system of tetraphony, as
documented by the diagrams of the Composite Trochos, the Tree of Parallage, and the Kanonion
of the Eight Modes. The intervals are diatonic (augmented seconds are absent). Nevertheless, in pieces
belonging to the family of mode 2, the melos requires different, chromatic sonorities, and the martyriai of mode 2
...
Figure 9.19. The first phrase of the sticheron “O Virgin Theologian,” mode 2, from MS A 139 sup., fol.23v, and the corresponding
phrase of the homonymous “sticheron for parallage” from MS NLG 928, fol. 167r, with transnotations.

![Description](image_10685.jpeg)
![Description](image_10686.jpeg)
![Description](image_10687.jpeg)

Metrophony as the rendering of a
troparion, only with stepwise movements,
without leaps, and its union with
DIATONIC PARALLAGE, as we
know it from the simple trochos.

Figure 9.20. The first phrase of the sticheron “O Virgin Theologian” as an exercise in metrophony & parallage, from MS NLG
928, fol. 167r, and the “Kanonion of the Eight Modes” from MS Holy Monastery of Dochiariou 338 (year 1767), fol. 5r. Within the blue
...
on systems other than the diatonic trochos are also theorized. Thus, for the sticheron “O Virgin Theologian” there is now
a corresponding kanonion with the specific mode (2): see Figure 9.21.

![Description](image_10688.jpeg)
![Description](image_10689.jpeg)

Figure 9.21. The beginning of the sticheron “O Virgin Theologian” from Sticherarium Ambrosianum A 139 sup., fol. 23v, with
transnotation, and a kanonion of mode 2, copied from the Anonymous theorist of MS NLG 968, fol. 180v.
Sources: Perria & Raasted (eds., 1992, MMB Facsimiles XI). Giannopoulos (2013, p. 116) and Alexandru (2000, vol. III, p.

17).

Comparing the old sticheron with its slow exegesis in the New Method, one observes a
complete agreement between the old notation, which records with its emphōna signs the
structural pitches of the melos, and the new notation, where the actual sonic result unfolds
analytically through the characters of Neo-Byzantine notation. From each structural pitch of the
...
Figure 9.22. The beginning of the sticheron “O Virgin Theologian” from Sticherarium Ambrosianum A 139 sup., fol. 23v, with
transnotation, and the slow exegesis by Chourmouzios, from MS NLG 707, fol. 222r, with schematic transcription on the
staff. Below: Matryoshka, work by the Russian artists Zvezdochkin and Malyutin, year 1892, Sergiev Posad Toy
Museum, from:
<https://upload.wikimedia.org/wikipedia/commons/3/3d/First_matryoshka_museum_doll_open.jpg> (8.5.2016).

The frequent alternation of the phthorai of mode 2 and of nenano in the exegesis, although in Middle Byzantine
notation they are entirely absent, is due to the fact that mode 2 in the old sticheraric melos
goes for the complete cadences to its low base, which coincides with the base of the plagal second mode.
In the Old System, the two modes have a common scale (from the pitch E - Vou). In the New Method, the
scales were differentiated, and mode 2 has Di as its high, melodic base and Ni as the low base of the scale,
whereas the plagal second is theoretically constructed from Pa. When the melos in the exegesis proceeds by
...
|1. mode|1st G a|a G a|a GF Ga a GF E FG a|
|---|---|---|---|
|2.|a E a|a D|a ¦ mode 2nd-pl.2nd h a h h aG FE FG h*|
|3.|h a h|h aG ah|h aG FGa h¦mode 3rd-barys chaGF|
|4.|Ga c|c G c|c F c ¦mode 4th-pl./4th d c d|
...
1. h: according to the MS, the transnotation ought to be : a. We have corrected it, however, to an ascent of two phonai, by analogy with the corresponding position
at the beginning of row 4., since in the isasmoi the final pitch of each formula coincides with the first .

Figure 9.23. The “Isasmos of the Eight Modes” from the Protheoria of the Papadike in MS NLG 2401, fol. 20v, prob. 1452-1469
(Politis & Politi, 1991), with the addition of alphabetic transnotation.xix © For the MS excerpts: National
Library of Greece.

##### 2.2.2.4. Gregory Bounes Alyates’ “Method of metrophony”: a brief note

The largest and most complicated exercise in metrophony is due to Gregory Bounes Alyates, the last
protopsaltes of Hagia Sophia in Constantinople before the Fall. It has a rich manuscript
tradition, and a host of epithets in the rubrics of the codices emphasize its importance: “very
useful,” “most useful,” “very beautiful.”xx Its incipit is “Ne, thus then ascend, thus
then descend,” and the method was written in the plagal fourth mode, at the same time documenting the
fundamental place of this mode in the teaching of the Psaltic Art.
Based on lists of signs, the eight-mode Great Ison of Saint John Koukouzeles, and
earlier exercises in metrophony, Alyates’ method presents an almost endless palette
of possibilities for measuring intervallic frameworks of one, two, three, four, five, seven, ten, and
eleven phonai. The verbal text beneath the sign-phonai is music-theoretical in character,
...
examples of theseis for two phonai (nos. 26-28). Signs and text from the Protheoria of MS
Patriarchate of Jerusalem, Anastasis Collection, no. 45, fol. 13v-14r, eighteenth century. Added are: identification of theseis,
...
Figure 9.24.e. Excerpt from the Method of metrophony of Gregory Bounes Alyates: examples
of theseis for two phonai (nos.47-48).

This Method of metrophony by Alyates constitutes a legacy of Byzantine musical
theory and pedagogy and shows how music-theoretical reflection systematizes and regulates
elements of musical practice and composition. For more information concerning this method, the
...
At the beginning of the sixteenth century, Akakios Chalkeopoulos (“fl. ca. 1490-1530”)xxiii speaks in
his Akribologēmata, among other things, also about the measuring of the phonai, which he presents as an arithmetical
check for the correctness or otherwise of the notation of musical pieces. More specifically, the Cretan
music theorist gives the example of the first verse from the Fourth Eothinon in mode 4, clarifying that
“it has ascending phonai, 19; likewise also descending.” The metrophonic calculation could be
clarified as follows (see Figure 9.25):

|1. 2. Ascending phonai: + 4 + 4 + 1 + 2 + 2 + 2 + 1 + 3 3. = 19|
|---|
|Descending phonai: -4 - 4 - 1 -1-1-1 - 1-1-1 = 19 - 2 - 2|

![Description](image_10702.jpeg)

Figure 9.25. The beginning of the Fourth Eothinon in mode 4, copied from the codices: 1. A 139 sup., fol. 299r, year 1341 and 2. NLG
917, fol. 3r, year 1500-1520, autograph of Akakios Chalkeopoulos (Chatzigiakoumis, 1980, p. 113). In no. 3 we give an
analytical account of the individual number of ascending and descending phonai, which are finally summed, leading
to the total of 19 ascending and likewise 19 descending phonai.
...
Listen to the beginning of the diagram by pressing 
Figure 9.27. The kanonion (κανόνιο) of metrophonia (μετροφωνία) in the Anonymous author of MS EBE 968, fol. 177r, with the addition of the corresponding
notes in the New Method for the eight strings of the diagram (left) and with the beginning of the resurrectional sticheron in
a setting by Chrysaphes the New, in late Middle Byzantine notation, together with a transfer of the metrophonic structure onto
the five-line staff.xxvi © for the MS excerpt: National Library of Greece.

After the Anonymous author of MS EBE 968 comes Chrysanthos of Madytos. As we saw
in section 1 of the present chapter, the great theorist of the New Method uses the
same musical example, “Our evening prayers,” in a setting by Chrysaphes the New, in order to
explain the mode of instruction according to the Old System, placing at the beginning of the triptych the
parallage (παραλλαγή), and subsequently the metrophonia and the melos (μέλος). In Figure 9.28 the two
...
- Parallage, according to Chrysanthos

- 71

- Metrophonia, according to Chrysanthos 72

- Melos, according to Chrysanthos 73 (slow exegesis)
...
Listen to lines 2&3 and 4 

Figure 9.29. 1. The diagram of the “perfect voice” (τελεία φωνή), EBE 968, fol. 176r, 17th c. (Giannopoulos, 2013, pp. 98, 110) ¦ Ison (ἴσον) and martyria (μαρτυρία) of the first mode in the Old System ¦
Cross-section of a matryoshka. 2. “Another useful parallage” (Tardo, 1938, p. 158) with transcription. 3. Codex Chrysander, pp. 17-18 (ed. Fleischer, 1904). 4. Chrysanthos
...
|Mode I II III IV|Old Method|Exegesis in the New Method by Petros Peloponnesios:|
|---|---|---|
...
 in theoretical manuals, metrophonia is referred to:
 as the foundation of the Psaltic Art (Gabriel Hieromonachos),
 as a way of tallying the voices of a phrase or a piece for orthographic checking (Akakios
Chalkeopoulos),
 as a method for understanding the structural pitches (phthongoi) — the basic intervallic structure of a piece,
with the aid of a special kanonion (κανόνιο), representing the pitches of the mode as strings, and placing
the sign-voices (σημαδόφωνα) on them along a vertical axis (Anonymous author of MS EBE 968, post-Byzantine period),
 as the simple rendering of the vocal signs of a piece in Middle Byzantine notation, with
a basic rhythm and with the poetic text of the particular troparion or hymn, as
preparation for a slow exegesis (Chrysanthos).

## Assessment criteria for Chapter 9

### Assessment criterion 1

Create indexing cards

for the central concepts of the present
...
Study the method “The Fourteen-Beacon Choir” (Choros tetradekapyrseutos).
...
entitled: Contemporary Questions and Answers on Key Concepts of
Psaltic Art in the Old System: metrophonia (μετροφωνία), parallage (παραλλαγή), and melos (μέλος). 
...
Learn by heart the intonation formula (απήχημα) of the first mode, together with its metrophony (μετροφωνία), parallage (παραλλαγή), and exegesis (εξήγηση) (Figure 9.29)
...
Menaion for September. (2002). (2nd ed.). Athens: Apostoliki Diakonia of the Church of Greece.

Catalogues of Byzantine musical and other manuscripts
...
Church of Greece - IBM. Vols. I-IV. Athens.
Hatzigiakoumis, Manolis. (1980). Manuscripts of Ecclesiastical Music 1453-1820. A contribution to the study
...
Gabriel Hieromonachos. On the signs in psaltic art. Ed. Chr. Hannick and G. Wolfram, Gabriel
...
John Plousiadenos. Explanation of parallage. In Antonios Alygizakis, The oktoechos in Greek liturgical
...
Akakios Chalkeopoulos' Ἀκριβολογήματα ('Akrivologemata' or 'Precise instructions') of Music. Paper presented at the
...
Alexandrou, Maria. (2010). Exegeseis and transcriptions of Byzantine music. A brief introduction to their
problematic. Thessaloniki: University Studio Press.
Alexandrou, Maria. (2016). Introduction to Byzantine Music. Library of Musicology 5, director: Dimitrios
...
Arvanitis, Ioannis. (2003). The rhythmic and metrical structure of Byzantine heirmoi and stichera as metre and as
the result of a new rhythmic interpretation of the Byzantine melos. In Efstathios G. Makris (ed.), The two
aspects of the Greek musical heritage. Tribute to the memory of Spyridon Peristeris. Proceedings of the
Musicological Meeting 10-11 November 2000, Athens Academy Mansion, Academy of Athens,
Publications of the Centre for Research in Greek Folklore no. 18 (pp. 151-176). Athens.
...
Corfu.
Karas, Simon. (1992). John maistor Koukouzeles and his age. Athens: Society for the Dissemination of
National Music.
...
to our own time. (2nd ed., greatly enlarged, ed. G. Hatzitheodorou). Athens: Dionysos.
...
"With golden words" in honour of St. John Chrysostom. Ed. Maria Alexandru. Studia palaeographica,
Preliminary version, Nr. 1. Iași: Centrul de Studii Bizantine Iași.
...
iii “For the so-called metrophonia is, as it were, the beginning and foundation. For he who has practised this well may easily
also acquire the other things of psaltic art; without it the chanter would have accomplished nothing. After this comes
parallage, which one must practise well, and in such a way that, in whatever pitch one may be, one is readily able
to render its echos. These things, then, characterize the chanter, but not yet the perfect one.”: Gabriel Hieromonachos, On
the signs in psaltic art (ed. Hannick & Wolfram, CSRM, vol. Ι, 1985, lines 587-594).
iv On the conceptual pair Struktursinn - Aufführungssinn, rendered here as structural level - performance level,
cf. Danuser (1998). On its application to Byzantine Music, see Alexandru (2000, vol. Ι, pp. 196-362).
On the pair quantity-quality, see, however, also Hagiopolites (ed. Raasted, 1983, § 30, pp. 37-38), where quality
is combined with the echoi. Cf. also Chourmouzios (ed. Giannopoulos, 2007, p. 77), concerning the intonation formula of the second
echos: “among us, however, it is intoned only with nes, which indicates the quality of neanes.”
v For the photography we thank Mr. Demosthenes Spanoudakis.
vi The copies of the musical examples and the corresponding caption are based on the following bibliography: Massip
(2007, pp. 21 and 41, pl. 9), Gertsman (1994, pl. LIV). For more information concerning the introduction of lines
into the Latin musical tradition, cf. Atkinson (2009, p. 229): "Guido first explains the underlying principle, a system
...
vii The copy was made on the basis of the microfilm of ms. Monastery of St Sabas 602 from the Collection of the Monumenta Musicae

Byzantinae in Copenhagen and from the facsimile edition of the Protheoria of Kosmas the Macedonian in Stathis
(1997, p. 38). For the dating of the manuscripts, see <http://www/catbyz.htm> (printed May 2000) and Stathis (1997, p.

33).

viii The present example comes from: Study Group for Byzantine Musical Palaeography (2008, p. 17).
ix The division into rhythmic feet is based on: Karas (1982, vol. I, pp. 142-153).
...
show many points of convergence with research by the scholars E. Jammers, J.v. Biezen, M. & I. Shkolnik: for
further details and bibliography, cf. Alexandrou (2010, pp. 41-42 and 74-75).
xiv In Figures 9.17.a-b there were added a division into disemic rhythmic feet, according to the research of Arvanitis
...
xviii Cf. John Plousiadenos, Explanation of parallage (ed. Alygizakis, 1985, p. 237, line 87 and p. 238,
lines 107-109).
xix A staff transcription of the Isasmoi, based on the ms. of Iviron Monastery 973, f. 15v, early fifteenth c.
(Stathis, 1993, p. 739), is found in Alexandru (2013, par. 12).
xx Cf. detailed references to the manuscripts and their rubrics for the present method in Alexandru (2013,
par. 17). See also Gemoll (1988, p. 819).
xxi Figures 9.24.a-e come from Alexandru (2013, par. 21.a-g).
xxii Cf. Alexandru, 2013, pp. 179-182 and 203-222.
xxiii Hatzigiakoumis (1999, p. 32).
xxiv This important diagram has been published several times: see, e.g., Psachos (1987, pl. XX). Alygizakis (1985, p.
...
more extensive account by the anonymous theoretician concerning the correct reading of the diagram, which the student
may find in: Giannopoulos (2013, pp. 111-113).
